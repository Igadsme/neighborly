...
- Listing detail negotiate, reserve, report, and share. Related cards for a UUID listing navigate with the live id. Message send on that listing does not create a thread.
